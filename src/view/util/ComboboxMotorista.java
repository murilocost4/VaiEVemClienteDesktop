...
public class ComboboxMotorista {
    ...
    // Método construtor
    public ComboboxMotorista(int key, String value) {
        this.key = key;
        this.value = value;
    }
    ...
    public static int getSelectedIndex(JComboBox combo){
        ...
        if (obj == null)
            ...
            return ((ComboboxMotorista) obj).getKey();// devolve o código da chave selecionada
    }
    ...
    public static void preencheComboBoxMotorista(int SelCodigo, JComboBox combo, ArrayList<Condutor> lista){
        ...
        for (Condutor c: lista){ 
            ...
            ComboboxMotorista cmb = new ComboboxMotorista(c.getCodUsuario(),c.getNomeUsuario());
